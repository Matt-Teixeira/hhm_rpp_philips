...
const pg_tables = {
    ...
    stats: {
        acquisition_history: new pgp.helpers.TableName({
            table: 'acquisition_history',
            schema: 'stats',
        }),
        tunnel_run_summary: new pgp.helpers.TableName({
            table: 'tunnel_run_summary',
            schema: 'stats',
        }),
    },
};
...
const pg_column_sets = {
    ...
    stats: {
        acquisition_history: new pgp.helpers.ColumnSet(
            [
                'run_id',
                'acq_run_id',
                'app_name',
                ...
                'error_category',
                'phase',
                { name: 'host_ip', cast: 'inet' },
                'tunnel_id',
                'endpoint_id',
            ],
            { table: pg_tables.stats.acquisition_history }
        ),
        tunnel_run_summary: new pgp.helpers.ColumnSet(
            [
                'run_id',
                'app_name',
                'tunnel_id',
                'endpoint_id',
                { name: 'subnet_24', cast: 'cidr' },
                'systems_total',
                'systems_success',
                'systems_failed',
                'systems_intervention',
                { name: 'err_cat_breakdown', mod: ':json' },
            ],
            { table: pg_tables.stats.tunnel_run_summary }
        ),
    },
    mag: {
        ge: {
